# BÁO CÁO QC SỐ HÓA CHUYÊN ĐỀ 04
- **ID Chuyên đề:** `chuyende_04`
- **Tên Chuyên đề:** Chuyên đề 4 - Hàm số bậc 2 và dấu tam thức bậc 2
- **Lớp:** 10
- **Môn học:** Đại số - Giải tích
- **Mật khẩu truy cập:** `cd04`
...
### Đợt 2 (Cập nhật ngày 21/05/2026)
...
1. **Câu 8 (Sửa kiến thức cơ bản & Đáp án đúng):**
   - *Lỗi:* Lời giải ghi "Parabol có bề lõm quay lên trên nên hệ số $a<0$" (sai kiến thức cơ bản). Lời giải ghi "Chọn B" nhưng kết luận lại ghi "Chọn đáp án D" và thẻ HTML cài sai `data-correct="D"`.
...
4. **Câu 14 (Bổ sung nội dung hướng dẫn giải):**
   - *Lỗi:* Phần Hướng dẫn giải bị trống.
...
5. **Dọn dẹp các ký tự rác do quét OCR ở nhiều câu:**
...
### Đợt 1 (Cập nhật ngày 21/05/2026)
...
### Số hóa ban đầu (Thực hiện ngày 21/05/2026)
* **OCR tài liệu gốc:** Chuyển đổi file PDF [cd04.pdf](file:///c:/Users/huyds/OneDrive/2.%20PARA/1%20-%20Projects/CaChep_Ecosystem/02_Distribution/List_Chuyende_Web/01_Inputs/chuyende_04/cd04.pdf) thành file Markdown thô [cd04.md](file:///c:/Users/huyds/OneDrive/2.%20PARA/1%20-%20Projects/CaChep_Ecosystem/02_Distribution/List_Chuyende_Web/01_Inputs/chuyende_04/cd04.md).
* **Chuẩn hóa Markdown:**
  - Thêm thẻ định danh lý thuyết `## PHẦN A. KIẾN THỨC CẦN NHỚ`.
  - Tách biệt phần bài tập trắc nghiệm bắt đầu từ Câu 1 dưới tiêu đề `## PHẦN C. BÀI TẬP TRẮC NGHIỆM`.
  - Phân chia mức độ câu hỏi rõ ràng (Cơ bản / Nâng cao).
  - File Markdown sau chuẩn hóa được lưu tại: [04_Ham_so_bac_2_va_dau_tam_thuc_bac_2.md](file:///c:/Users/huyds/OneDrive/2.%20PARA/1%20-%20Projects/CaChep_Ecosystem/02_Distribution/List_Chuyende_Web/02_Processing/04_Ham_so_bac_2_va_dau_tam_thuc_bac_2.md).
* **Biên dịch HTML:** Chạy biên dịch thành công file HTML tương tác: [chuyende_04.html](file:///c:/Users/huyds/OneDrive/2.%20PARA/1%20-%20Projects/CaChep_Ecosystem/02_Distribution/List_Chuyende_Web/03_Outputs/chuyende_04.html).
* **Cập nhật cơ sở dữ liệu:** Cập nhật số câu từ `0` thành `40` cho `chuyende_04` trong file [quan_ly_chuyen_de.csv](file:///c:/Users/huyds/OneDrive/2.%20PARA/1%20-%20Projects/CaChep_Ecosystem/02_Distribution/List_Chuyende_Web/quan_ly_chuyen_de.csv).
...
- [x] Liên kết ảnh: Load ảnh sơ đồ đồ thị/parabol ổn định qua link Mathpix.
- [x] Đáp án đúng: Trích xuất và đối chiếu chính xác (Khớp 40/40 câu hỏi).
